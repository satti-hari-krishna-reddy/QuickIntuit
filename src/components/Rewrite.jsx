...
function ReWrite({ text, clear, replaceText }) {
  ...
  const context =
    'The provided text needs to be rewritten while preserving its original meaning and improving clarity, and readability. Ensure the output strictly follows the selected format without introducing any additional formatting (unless specified) or commentary.';
